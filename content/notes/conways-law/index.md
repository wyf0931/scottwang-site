...
这个说法来自程序员 Melvin Conway，1967 年写在一篇投稿里。他当时想表达的意思很简单，系统的各个模块之间需要人去协调接口，而人跨部门沟通的成本天然比部门内部高。所以系统的边界，会不知不觉地跟组织的边界对齐。
...
Nigel Bevan 在 1997 年的一篇论文里写过类似的观察。很多公司做的网站，内容结构反映的是公司内部的部门划分，而不是用户想看到的东西。产品部负责产品页面，市场部负责品牌页面，技术部负责 API 文档。用户关心的问题，比如"这个产品跟竞品比怎么样"，可能跨越三个部门，谁都没有完整地回答。

## MIT 和哈佛的研究者认真验证过

康威定律听着像经验之谈，但有人拿数据验证过。

MIT 的 Alan MacCormack 和哈佛商学院的 Carliss Baldwin 合作过一个研究项目，叫做"镜像假说"（Mirroring Hypothesis），核心问题是组织架构和产品架构之间到底存不存在系统性的对应关系。

结论是存在的。他们对比了组织结构松散和紧密的两类公司，发现松散组织的产出明显比紧密组织更模块化。组织怎么拆，产品就怎么分，这组对应关系在统计上显著，不是巧合。
...
第二条像是项目管理里的铁律。第三条在说层级结构和管道结构之间的对应，编译器的多遍处理就是个例子。第四条在讲规模效应，系统一旦大到一定程度，组织和架构双方都会自然趋向拆分。
...
做微服务拆分的时候，很多人会先画团队边界，再看系统怎么拆。Confluent 的联合创始人 Jay Kreps 写过一个著名的帖子，叫"没有好的团队边界就做不好的系统设计"，核心观点就是先搞定人的组织方式，系统架构会自然跟上来。

反过来也一样。如果你发现系统的某些模块之间的耦合总是解不开，也许问题不在技术，在于这两个模块背后的两个团队之间没有建立起足够的沟通机制，或者干脆就是两个不该分开的团队被硬分开了。

康威定律的威力在于，它把一个看似纯技术的问题，拉到了人和组织的层面。下次你觉得系统架构"不太对"，但又说不清哪里不对的时候，也许可以先看看团队是怎么分的。
